...
# generate: open /Users/hasanturken/Workspace/crossplane-contrib/upjet-provider-template/apis/rabbitmq/v1alpha1/zz_generated.deepcopy.go: no such file or directory
rm -rf apis/rabbitmq
# remove the sample directory which was a configuration in the template
rm -rf config/rabbitmq
